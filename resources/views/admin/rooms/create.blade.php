...
@section('title', 'Tambah Ruang Rawat Inap')

@section('content')
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="h3 mb-0 text-gray-800">Tambah Ruang Rawat Inap</h1>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('room_type') is-invalid @enderror" id="room_type"
                                    ...
                                    <option value="Kelas 1" {{ old('room_type') == 'Kelas 1' ? 'selected' : '' }}>Kelas 1
                                    </option>
                                    <option value="Kelas 2" {{ old('room_type') == 'Kelas 2' ? 'selected' : '' }}>Kelas 2
                                    </option>
                                    <option value="Kelas 3" {{ old('room_type') == 'Kelas 3' ? 'selected' : '' }}>Kelas 3
                                    </option>
                                </select>
                                @error('room_type')
                                    <div class="invalid-feedback">{{ $message }}</div>
