...
@section('content')
    <div class="container-fluid">
        ...
        <!-- Form untuk mengedit kunjungan -->
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Form Edit Kunjungan</h6>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('admin.appointments.update', $appointment->id) }}">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('status') is-invalid @enderror" id="status"
                                    ...
                                    <option value="Selesai"
                                        {{ old('status', $appointment->status) == 'Selesai' ? 'selected' : '' }}>Selesai
                                    </option>
                    ...
                    <div class="text-center mt-4">
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save"></i> Perbarui Kunjungan
                        </button>
