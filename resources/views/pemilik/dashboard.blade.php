            ...
            <div class="col-xl-8 col-lg-7">
                <div class="card shadow mb-4">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-primary">Ringkasan Kunjungan (7 Hari Terakhir)</h6>
                    </div>
                    <div class="card-body">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                            ...
                            <div class="list-group">
                                @foreach ($recentReports as $report)
                                    <a href="{{ route('pemilik.reports.show', $report->id) }}"
                                        ...
                                        <small>{{ $report->start_date->format('d M Y') }} -
                                            {{ $report->end_date->format('d M Y') }}</small>
                                    </a>
                                @endforeach
                            </div>
                        @else
                        ...
                        <div class="text-center mt-3">
                            <a href="{{ route('pemilik.reports.index') }}" class="btn btn-primary btn-sm">
                                Lihat Semua Laporan
                            </a>
                        </div>
                    </div>
